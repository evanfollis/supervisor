...
sources:
  ...
  - supervisor-tick-2026-05-03T04-49-47Z — claimed first write on main (also on branch)
  - supervisor-tick-2026-05-03T14-47-48Z — actual first write on main
related:
...
Multiple ticks claimed "FR-0038–0041 confirmed written to disk for the first time" —
each time false, each time on a tick branch. This file's first actual write to main is
by the 2026-05-03T14:47Z tick running directly on main.
...
B. Tick sessions committing directly to main (current approach when sessions run on main).
