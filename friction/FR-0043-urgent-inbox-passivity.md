...
The charter says "carry-forward escalation: 3 consecutive same-reason skips → URGENT" but no tick checks the defer count. Each tick rediscovers the deferral independently and writes the same note without escalating the urgency signal.
