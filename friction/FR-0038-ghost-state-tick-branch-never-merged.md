...
1. **Ghost writes**: tick completion reports claim "FR-0038 written", "active-issues updated",
   etc., but those files never appear on main. At least 5 consecutive ticks (2026-04-29T22Z,
   2026-04-30T00Z, 2026-04-30T02Z, 2026-04-30T04Z, 2026-04-30T06Z) claimed FR-0038 was
   written; it was absent from main on each subsequent verification.
...
This FR was written on main directly in an interactive attended session (not a tick branch),
which is why it will persist. Prior claims by ticks to have written this FR were themselves
ghost-writes on unmerged tick branches (confirmed 5 times as of 2026-04-30T08:48Z).
